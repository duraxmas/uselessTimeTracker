...
class DashboardItem {
  ...
  createMarkup() {
            ...
            <div class="dashboard__item dashboard__item--${id}">
                <article class="tracking-card">
                    <header class="tracking-card__header">
                        ...
                        <img class="tracking-card__btn" src="images/icon-ellipsis.svg" alt="menu">
                    </header>
                    <div class="tracking-card__body">
                        <div class="tracking-card__cur-time">
                            ${current}hrs
                        </div>
    ...
    this.time = this.container.querySelector(`.dashboard__item--${id} .tracking-card__cur-time`);
